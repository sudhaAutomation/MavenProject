...
public class AddCategoryTest23 {
	public static WebDriver driver;

	@BeforeMethod

	public void beforeMethod() { // This method is used to pass parameters into class methods

		System.setProperty("webdriver.chrome.driver",
				"C:\\Users\\SWHIZZ TECHNOLOGIES\\Downloads\\jars\\chromedriver.exe");
		driver = new ChromeDriver();
		driver.manage().window().maximize();
		driver.get("http://integratedtoolingsystems.in/1swishzz_staging/admin");// we have passed the elements
	...
	public static String[][] getData() throws IOException {
		...
		int colcount = xl.getCellCount("addCategory", 2);// to know the no.of columns u must write atleast 1 row number
